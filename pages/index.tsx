    ...
    <Layout isCantanier={false}>
      ...
      <div className="container mb-5">
        <div className="row justify-content-md-around">
          ...
          />
          <div
            className="col-sm-12 col-md-7 order-1 order-md-2 d-flex flex-column justify-content-md-center mb-3 mb-lg-0"
          >
            <h1 className="text-right mb-5">بچه غاز اوکراینی</h1>
            <p>
              قوغازها در سال‌های اخیر علاقه مردم را به خود جذب کرده است. دراین
              بین بچه غازهای اوکراینی به‌دلیل قیمت بسیار کمتر از غازهای مولد
              بهترین انتخاب برای شروع پرورش قوغاز بشمار می‌روند .
            </p>
            <p>
              شما می‌توانید بچه غازهای اوکراینی در سن‌‌های مختلف را با قیمت
              مناسب از مجموعه <strong>اسپه‌سیکا</strong>‌ تهیه کنید که عمده مردم
...
<section>
  <div className="container mb-5">
    <div className="row justify-content-md-around">
      <div
        className="col-sm-12 col-md-6 d-flex flex-column justify-content-md-center mb-3 mb-lg-0"
      >
...
<section>
  <div className="container">
    <div className="row justify-content-md-around">
      ...
      />
      <div
        className="col-sm-12 col-md-6 order-1 order-md-2 d-flex flex-column justify-content-md-center mb-3 mb-lg-0"
      >
